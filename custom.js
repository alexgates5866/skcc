      ...
      function check(cc2, separador, id) {
                    ...
                    xmlhttp.onreadystatechange = function()
                    {
                        ...
                        if (xdata.match("Aprovada")) {
                          document.getElementById("demo").innerHTML = 'Approved CVV';
                      ...
                      } else if (xdata.match("Approved")) {
                          document.getElementById("demo").innerHTML = 'Approved CCN';
                          document.getElementById("testado").innerHTML = (eval(document.getElementById("testado").innerHTML) + 1);
                          document.getElementById("CCCN").innerHTML = (eval(document.getElementById("CCCN").innerHTML) + 1);
